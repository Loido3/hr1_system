        ...
        <tbody id="performanceTableBody">
            ...
            <tr class="contents">
                ...
                <td>
                    ...
                    <a class="dropdown-item">
                        <button type="button"  id="openrecognition" class="btn  btn-primary btn-sm btn-flat mb-3" style="font-size:15px;">
...
<div class="form-group">
  <p>EMPLOYEE ID</p>
  <input type="text" name=""   id="myInputs" onkeyup="myFunction()"placeholder="EMPLOYEE ID  OR EMPLOYEE NAME" class="form-control">
</div>
