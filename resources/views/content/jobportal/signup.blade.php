 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-primary  " style="padding:0px;" >
  <div class="container-fluid">
   ...
   <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="javascript:void(0) "  style="font-size:20px">About</a>
      <a class="nav-item nav-link" href="javascript:void(0) "  style="font-size:20px">Contact</a>
       ...
       <a class="nav-item nav-link" href="{{url('/')}}"  style="font-size:20px;position:relative;top:-5px;"><button class="btn btn-success" id="login">Login</button></a>
...
<p style="color:blue;text-align:center;font-size:30px;">REGISTER AN ACCOUNT</p>
...
<div class="row mb-2">
  ...
  <div class="col-md-6">
    ...
    <label>Age</label>
  <input type="number" name="age" class="form-control" style="background-color: inherit; border-top: none; border-left: none; border-right: none; box-shadow: none !important; border-color: #000 !important;" required>
</div>
  </div>
</div>
